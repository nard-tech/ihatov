...
Ruby **3.4以上**。現在は25作品から157件（詩21、短歌29、俳句2、散文26、地名52、登場者18、擬音語9）を収録しています。
...
末尾改行やHTMLは付けません。必要なルビは括弧で表記します。義務教育水準で読みが明らかな一般語には付けません。
...
変更にはテストを追加し、PRで提案してください。CIはRuby 3.4・4.0でRSpecとgemのビルド・インストール後の利用を確認し、RuboCopとYARDも実行します。新しい安定版Rubyが出たらマトリクスを更新します。
