...
module Ihatov
  ...
  class Source
    ...
    # @return [String] 指定された URL、または採用版の URL
  ...
  class Value < String
    ...
    # @return [String] 種別内で一意な、手動で定義する固定 ID
  ...
  class Place < Value
    ...
    attr_reader :real
    # @return [Hash{Symbol => Float}, nil] WGS 84 の緯度・経度を格納した凍結ハッシュ
