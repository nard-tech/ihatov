...
module Ihatov
  ...
  module Collection
    ...
    #   only for places
    # @option conditions [Boolean, String] :indent 詩のみ。true は字下げあり、false は字下げなし。
